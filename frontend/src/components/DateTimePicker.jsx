...
const SELECT_CLS =
  "rounded-lg bg-gray-100 dark:bg-gray-800 px-2 py-2 text-sm text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500";
  ...
  return (
    <div className={`flex items-center gap-2 flex-wrap ${className}`}>
      <input
        ...
        className="rounded-lg bg-gray-100 dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
      />
      <select
        value={hour}
